...
const FIREBASE_AUTH_DOMAIN = String(process.env.FIREBASE_AUTH_DOMAIN ?? "invalid");
const FIREBASE_PROJECT_ID = String(process.env.FIREBASE_PROJECT_ID ?? "invalid");
const FIREBASE_STORAGE_BUCKET = String(process.env.FIREBASE_STORAGE_BUCKET ?? "invalid");
const FIREBASE_MESSAGING_SENDER_ID = String(process.env.FIREBASE_MESSAGING_SENDER_ID ?? "invalid");
const FIREBASE_APP_ID = String(process.env.FIREBASE_APP_ID ?? "invalid");

const WORDLE_BOT_CHANNEL_NAME = String(process.env.WORDLE_BOT_CHANNEL_NAME ?? "invalid");
